...
import { fetchDonations as fetchDonationsFromAPI } from "../../services/donorService";

// ─────────────────────────────────────────────────────────────────────────────
// API CONNECTION POINT
// The page now loads from the live donation service and falls back to the
// existing mock dataset only when the database table is empty.
// ─────────────────────────────────────────────────────────────────────────────
async function fetchDonations() {
  const data = await fetchDonationsFromAPI();
      ...
      <div className="dn-drawer">
        ...
        <div className="dn-drawer__body">
          ...
          <div className="dn-drawer__amount">
            <div className="dn-drawer__amount-value">
          ...
          <div className="dn-drawer__avatar-wrap">
            <div
              ...
              style={
                !isAnon
                  ? { background: `${donation.color}22`, color: donation.color }
                  : {}
              }
            >
              {isAnon ? (
                <Ic n="user" s={22} c="rgba(255,255,255,0.25)" />
              ) : (
          ...
          <p className="dn-drawer__email">
            {isAnon ? "No account linked" : donation.email}
          </p>

          <div className="dn-drawer__pills">
            <span
              className="dn-type-pill"
              style={
                isAnon
                  ? {
                      background: "#1E1E1E",
                  ...
                  : {
                      ...
                      color: "#FE4081",
                      borderColor: "rgba(196,18,98,0.3)",
                    }
              }
            >
          ...
          <div>
            <p className="dn-drawer__section-title">
              How this donation is split
            </p>
            {ALLOCATION.map((a) => {
              ...
              return (
                <div key={a.label} className="dn-drawer__alloc-item">
                  ...
                  <div className="dn-drawer__alloc-bar">
                    <div
                      className="dn-drawer__alloc-fill"
                      style={{ width: `${a.pct}%` }}
                    />
                  </div>
                </div>
    ...
    <div className="dn-root">
      ...
      <div className="dn-header dn-anim" style={{ animationDelay: "0ms" }}>
        <div>
          ...
          <p className="dn-header__sub">
            Track all contributions to the SheIsDesign community fund.
          </p>
        </div>
      ...
      {/* ── Table */}
      <div
        className="dn-table-wrap dn-anim"
      ...
      >
        {loading ? (
          ...
          <div className="dn-empty">
            No donations found{search ? ` matching "${search}"` : ""}.
          </div>
        ) : (
              ...
              {paged.map((d) => {
                ...
                return (
                  <tr key={d.id} onClick={() => setSelected(d)}>
                    ...
                    <td>
                      <div className="dn-donor">
                        ...
                        <div>
                          ...
                          {d.email && (
                            <div className="dn-donor__email">{d.email}</div>
                          )}
                        </div>
                      </div>
                    </td>
                    ...
                    <td>
                      <span
                        className={`dn-amount${isLarge ? " dn-amount--large" : ""}`}
                      >
                        {fmtAmount(d.amount)}
                      </span>
                    </td>
                        ...
                        style={
                          isAnon
                            ...
                            : {
                                ...
                                color: "#FE4081",
                                borderColor: "rgba(196,18,98,0.25)",
                              }
                        }
                      >
                        <Ic
