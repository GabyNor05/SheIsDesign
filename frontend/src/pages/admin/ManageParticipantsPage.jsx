...
// Expected shape: array of participant objects (see MOCK_PARTICIPANTS below)
// Example real call:
//   const res = await fetch("/api/participants", { headers: { Authorization: `Bearer ${token}` } });
//   return await res.json();
// ─────────────────────────────────────────────────────────────────────────────
async function fetchParticipants() {
  // 🔌 CONNECT API HERE — remove the line below and uncomment the real call
...
const MOCK_PARTICIPANTS = [
  ...
  { id: 4,  type: "student",       initials: "TK", name: "Thandi Khumalo",    email: "thandi@uct.ac.za",       institution: "University of Cape Town", field: "Visual Communication", status: "pending",  joined: "28 Apr 2026",  submissions: 0, points: 0,   color: "#FBBF24" },
  { id: 5,  type: "student",       initials: "ZP", name: "Zoë Petersen",      email: "zoe@uct.ac.za",          institution: "University of Cape Town", field: "Brand Strategy",       status: "approved", joined: "20 Apr 2026",  submissions: 5, points: 870, color: "#a78bfa" },
  { id: 6,  type: "student",       initials: "KM", name: "Keabetswe Molefe",  email: "keab@nwu.ac.za",         institution: "NWU",                     field: "Motion Design",        status: "approved", joined: "15 Apr 2026",  submissions: 2, points: 350, color: "#34d399" },
  { id: 7,  type: "student",       initials: "LB", name: "Laila Brown",       email: "laila@uj.ac.za",         institution: "UJ",                      field: "Photography",          status: "rejected", joined: "10 Apr 2026",  submissions: 0, points: 0,   color: "#f97316" },
  { id: 8,  type: "student",       initials: "NM", name: "Nandi Mahlangu",    email: "nandi@dut.ac.za",        institution: "DUT",                     field: "Web Design",           status: "approved", joined: "8 Apr 2026",   submissions: 4, points: 600, color: "#fb7185" },
  ...
  { id: 10, type: "professional",  initials: "ZPR",name: "Zoe Pretorius",     email: "zoe@fcb.co.za",          institution: "FCB Africa",              field: "Art Direction",        status: "pending",  joined: "29 Apr 2026",  submissions: 0, points: 0,   color: "#34d399" },
  { id: 11, type: "professional",  initials: "MB", name: "Mpho Baloyi",       email: "mpho@freelance.co.za",   institution: "Freelance",               field: "Brand Strategy",       status: "approved", joined: "27 Apr 2026",  submissions: 0, points: 0,   color: "#f97316" },
  { id: 12, type: "professional",  initials: "TN", name: "Tebogo Nkuna",      email: "tebogo@king.co.za",      institution: "King James Group",        field: "Digital Strategy",     status: "rejected", joined: "22 Apr 2026",  submissions: 0, points: 0,   color: "#60A5FA" },
];
...
function ParticipantDrawer({ person, onClose, onApprove, onReject }) {
  ...
  return (
    <div className="p-drawer-overlay" onClick={e => { if (e.target === e.currentTarget) onClose(); }}>
                ...
                <tr key={person.id} onClick={() => setSelected(person)}>
                  ...
                  <td>
                    <div className="p-row-actions" onClick={e => e.stopPropagation()}>
                      ...
                      {person.status === "pending" && (
                        <>
                          <button className="p-icon-btn" aria-label="Approve"
                      ...
                      <button className="p-icon-btn p-icon-btn--danger" aria-label="Remove"
