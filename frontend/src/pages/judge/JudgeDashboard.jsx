...
function EventCard({ event, onScore }) {
  ...
  const pct =
    event.submissions > 0
      ? Math.round((event.scored / event.submissions) * 100)
      : 0;
  ...
  return (
    ...
    >
      ...
      {/* Top */}
      <div
        style={{ padding: "16px 18px 12px", borderBottom: "1px solid #242424" }}
      >
        <div
          style={{
            display: "flex",
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
          ...
          >
            <Ic n="cal" s={12} c="rgba(255,255,255,0.3)" /> Event:{" "}
          ...
          >
            <Ic n="clock" s={12} c="rgba(255,255,255,0.3)" /> Score by:{" "}
            {fmtDate(event.deadline)}
          </div>
          <div
            style={{
              display: "flex",
          ...
          >
            ...
            {!isDone && (
              <span style={{ color: "#FE4081", fontWeight: 600 }}>
                · {event.submissions - event.scored} remaining
              </span>
            )}
          </div>
        </div>
          ...
          >
            <div
              style={{
                ...
                background: isDone
                  ? "#22C55E"
                  : `linear-gradient(90deg, #C41262, #FE4081)`,
                borderRadius: 3,
      ...
      <div style={{ borderTop: "1px solid #242424", display: "flex" }}>
        ...
        <a
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.background = "#1E2A1A";
        ...
        <button
          ...
          style={{
            ...
            background: isDone
              ? "none"
              : "linear-gradient(135deg, #C41262, #FE4081)",
            border: "none",
            padding: "12px 0",
            cursor: "pointer",
        ...
        >
          {isDone ? (
            ...
            <>
              <Ic n="arrow" s={13} c="#fff" />{" "}
              {event.scored > 0 ? "Continue" : "Start Scoring"}
            </>
          )}
        </button>
      </div>
...
export default function JudgeDashboard() {
  ...
  const totalPending = events.reduce(
    (s, e) => s + (e.submissions - e.scored),
    0,
  );
  const totalComplete = events.filter(
    (e) => e.scored === e.submissions && e.submissions > 0,
  ).length;
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "32px 28px" }}>
        ...
        <div
          ...
          style={{
            animationDelay: "0ms",
            background:
              "linear-gradient(135deg, #2D0A1A 0%, #1A0A14 40%, #0D0D0D 100%)",
        ...
        >
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(circle, rgba(196,18,98,0.18) 0%, transparent 70%)",
              pointerEvents: "none",
            }}
          />
            ...
            >
              ...
              {totalPending > 0 && (
                ...
                >
                  ...
                  {totalPending} submission{totalPending !== 1 ? "s" : ""} need
                  your score
                </span>
              )}
            </div>
        ...
        >
          {STATS.map((s) => (
            <div
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = "rgba(196,18,98,0.35)";
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                          {remaining} submission{remaining !== 1 ? "s" : ""} to
                          score · Due {fmtDate(ev.deadline)}
                        </div>
                      </div>
                      {urgency && (
                        <span
            ...
            >
              {events.map((ev) => (
                <EventCard
                  key={ev.id}
                  event={ev}
                  onScore={(id) => navigate(`/judge/score/${id}`)}
                />
              ))}
            </div>
          )}
