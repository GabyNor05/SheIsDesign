...
function QuickActions() {
  ...
  const buttonAction = (id) => {
    switch (id) {
      case 1: setModal("create"); break;
      case 2: setModal("invite"); break;
      case 3: navigate("/admin/leaderboard"); break;
      default: break;
    }
  };
  ...
  return (
    <div className="quick-actions">
      ...
      {modal === "invite" && (
        ...
        >
          <div className="ev-modal-box ev-modal-box--narrow" style={{ position:"relative" }}>
            <div className="ev-modal-glow" />
            <div className="ev-modal-header">
              <div className="ev-modal-header__left">
                <span className="ev-modal-eyebrow">
                  <span className="ev-modal-eyebrow-dot" />Admin · Judges
                </span>
                <h2 className="ev-modal-title">Invite Judge</h2>
              </div>
              <button className="ev-modal-close" onClick={() => setModal(null)}>
                <Ic n="close" s={14} c="currentColor" />
              </button>
            </div>
            <div className="ev-modal-body" style={{ color:"rgba(255,255,255,0.5)", fontSize:13, fontFamily:"Poppins, sans-serif" }}>
              Invite judge form coming soon.
              <div className="ev-form-footer">
                <button className="ev-btn-ghost" onClick={() => setModal(null)}>Close</button>
              </div>
            </div>
          </div>
        </div>
